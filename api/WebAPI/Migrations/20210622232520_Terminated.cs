...
{
    public partial class Terminated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduleUser", x => new { x.SchedulesId, x.StudentsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ScheduleUser_Users_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleUser_StudentsId",
                table: "ScheduleUser",
                column: "StudentsId");
